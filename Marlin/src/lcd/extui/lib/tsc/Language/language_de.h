...
#define _LANGUAGE_DE_H_
    ...
    #define DE_RUNOUT_OFF           "Leerlaufen AUS"
    #define DE_RUNOUT_ON            "Leerlaufen EIN"
    ...
    #define DE_MAINMENU             "Speisekarte"
    ...
    #define DE_ELAPSED_TIME         "zeitaufwendig"
